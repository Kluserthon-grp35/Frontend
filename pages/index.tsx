    ...
    <LandingLayout>
      ...
      <main className=" mb-[117px] px-20">
        <section className=" text-center py-20">
          <h2 className=" text-5xl font-semibold text-text mb-12">
            Why choose us?
          </h2>
          <p className=" text-[24px]">
            Our clients discuss how PayZen takes care of genuine business issues
            for them
          </p>
        </section>
      ...
      <div className=" px-20 py-28 w-full min-h-screen bg-gradient ">
        <section className=" w-full mb-28 text-center">
          <h2 className=" text-white text-[48px] font-semibold">
            Trusted by over 500 Business Owners{" "}
          </h2>
